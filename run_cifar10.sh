...
# cifar10_nonamplified cifar10_dpsgd_momentum cifar10_dpmuon cifar10_bandinv_dpmuon_naive cifar10_dpadamw cifar10_bandinv_dpadamw_naive cifar10_bandinv_dpadamw_stp cifar10_bandinv_dpadamw_segmented cifar10_bandinv_dpadamw_frozen_p cifar10_public_v_bandinv cifar10_bandinv_dpadamw_shadow_jme
export PYTHONPATH="$ROOT/src${PYTHONPATH:+:$PYTHONPATH}"
DEFAULT_CONFIG="$ROOT/config/cifar10_bandinv_dpadamw_frozen_p.yaml"
